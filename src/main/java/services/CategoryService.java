...
public interface CategoryService {
     ...
     * @throws ResourceNotFound If no category had a matching ID
    ...
    /**
     * Deletes the cateogry with a matching ID
     * 
     * @param categoryId - Cateogry ID being removed
     * @throws ResourceNotFound If the ID provided doesn't exist
     ...
     * @throws ResourceNotFound - If category ID doesn't exist
     * @throws InvalidValue - If assessment ID doesn't exist
     */
    Category addCategory(int assessmentId, int categoryId) throws ResourceNotFound, InvalidValue;

    /**
     * Gets all categories attached to an assessment
     * 
     * @param assessmentId - The assessment ID categories
     * @return A list of cateogires attached to the assessment
     */
